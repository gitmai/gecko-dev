...
loop.conversationViews = (function(mozL10n) {
   ...
   */
  var FailureView = React.createClass({displayName: "FailureView",
    mixins: [
      Backbone.Events,
    ...
    render: function() {
      ...
      return (
        React.createElement("div", {className: "call-window"}, 
          React.createElement("div", {className: "error-hello-logo"}), 
          React.createElement("h2", null, this._getMessage()), 

          React.createElement("div", {className: "btn-group call-action-group"}, 
            React.createElement("button", {className: "btn btn-rejoin", 
    ...
    render: function() {
      ...
      switch (this.state.callState) {
        ...
        case CALL_STATES.TERMINATED: {
          return (React.createElement(FailureView, {
            contact: this.state.contact, 
            dispatcher: this.props.dispatcher}));
        }
